...
sourcesIndex["dynec"] = {"name":"","dirs":[{"name":"comp","files":["any.rs"]},{"name":"entity","files":["ealloc.rs","permutation.rs","referrer.rs"]},{"name":"system","files":["spec.rs"]},{"name":"world","dirs":[{"name":"scheduler","files":["builder.rs","planner.rs","topology.rs"]}],"files":["builder.rs","scheduler.rs","storage.rs","typed.rs"]}],"files":["archetype.rs","comp.rs","entity.rs","global.rs","lib.rs","macros.rs","system.rs","util.rs","world.rs"]};
