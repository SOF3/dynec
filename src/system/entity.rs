...
pub struct EntityIteratorImpl<A: Archetype> {
    ealloc: ealloc::Snapshot<A::RawEntity>,
}

impl<A: Archetype> EntityIterator<A> for EntityIteratorImpl<A> {
...
pub fn entity_iterator<A: Archetype>(
    ealloc: ealloc::Snapshot<A::RawEntity>,
) -> impl EntityIterator<A>
where
{
